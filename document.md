...
Using join clause, the join queries above can be expressed as:
...
Note that all the five appearances of the same join intent so far yeld equivalently efficeint query execution plans generated by AsterixDB query optimizer. 
